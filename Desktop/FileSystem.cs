...
namespace Film_DB_V2
{
    public class FileSystem
    {
        ...
        public List<string> getAllSubFolders(string path = "")
        {
        ...
        public List<KeyValuePair<string, string>> getAllSubfoldersWithPath(string path = "")
        {
        ...
        public List<string> getDirectoryTree(string path = "",bool listSubfolders=false)
        {
            string filestring = "";
            List<string> files = new List<string>();
            if (path == "")
        ...
        public void setFileAtributes(FileAttributes setting, string filePath="")
        {
            try
            {
        ...
        public void setFileAtributesRecursive(FileAttributes setting, string filePath="")
        {
        ...
        public string getNewestFileInFolder(string folder="")
        {
            string newestFile = "";
